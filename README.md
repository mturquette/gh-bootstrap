...
Creation of an index.html and content under **_posts** is up to you. It
is trivial for you to merge new versions of gh-bootstrap after you have
used it to build your own website; there will be no merge conflicts with
**index.html**, anything under **_posts** or anything under
**_layouts**.
